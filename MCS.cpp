...
void threadWork(int id, int numOps, double lamda1, double lamda2, double pl, double pi, MCSLock& lckObj);
...
void threadWork(int id, int numOps, double lamda1, double lamda2, double pl, double pi, MCSLock& lckObj) {
    ...
    string logFileName = "Thread_LogFile(MCS)_" + to_string(id+1) + ".log";
