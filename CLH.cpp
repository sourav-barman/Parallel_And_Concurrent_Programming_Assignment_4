...
void threadWork(int id, int numOps, double lamda1, double lamda2, double pl, double pi, CLHLock& lckObj);
...
void threadWork(int id, int numOps, double lamda1, double lamda2, double pl, double pi, CLHLock& lckObj) {
    ...
    string logFileName = "Thread_LogFile(CLH)_" + to_string(id+1) + ".log";
